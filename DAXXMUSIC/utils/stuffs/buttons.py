...
class BUTTONS(object):
    MBUTTON = [[InlineKeyboardButton("⚜️𝗖𝗵𝗮𝘁𝗚𝗽𝘁⚜️", callback_data="mplus HELP_ChatGPT"),InlineKeyboardButton("ɢʀᴏᴜᴘs", callback_data="mplus HELP_Group"),InlineKeyboardButton("sᴛɪᴄᴋᴇʀs", callback_data="mplus HELP_Sticker")],
    ...
    InlineKeyboardButton("💛𝗧𝗿𝘂𝘁𝗵-Dare💛", callback_data="mplus HELP_TD"),InlineKeyboardButton("ʜᴀsᴛᴀɢ", callback_data="mplus HELP_HT")], 
    [InlineKeyboardButton("💚𝗧𝘁𝘀💚", callback_data="mplus HELP_TTS"),
    InlineKeyboardButton("💜𝗙𝘂𝗻💜", callback_data="mplus HELP_Fun"),InlineKeyboardButton("ǫᴜᴏᴛʟʏ", callback_data="mplus HELP_Q")],          
